# Epsilon Health — Website

## Design intent

This website presents Epsilon Health as a private medical residence: clinically credible, calm, personal, and quietly premium. It combines hospitality-led interiors with restrained editorial typography and warm, natural color.
...
- Main image: `assets/lobby-1-logo-updated.png`
- Focal: `28% center` desktop / tablet rail; `34% center` at ≤520px full-bleed
- Full-height right-rail media at all widths; at ≤520px the rail becomes full-width (no mask strip). Not a stacked/16:9 crop.
- “One place. A lifetime of care.” is an open editorial aside with a fine champagne rule, not a glass card.
- The circular atmosphere and oversized background word are intentionally subtle (wide desktop only).
...
- Refer to the location as 5111 Maryland Way, Brentwood, TN
...
- `assets/` contains the clinic photography used by the site.
